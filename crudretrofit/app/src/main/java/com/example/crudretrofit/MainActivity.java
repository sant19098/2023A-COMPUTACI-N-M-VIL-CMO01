...
//--------------------------------------------------------------------------------
        ...
        private void CrearEmpleado () {
           ...
           // Empleado nuevoEmpleado = new Empleado(2L, "John", "password123", "john@example.com");
            Call<Empleado> call = CrudEmpleadoInterface.crearEmpleado(empleado);
...
//            Long idEmpleadoAEliminar = Long.valueOf(1);
        ...
        private void Actualizar () {
           ...
           // Empleado empleadoActualizado = new Empleado(1L, "Juan", "nuevo_pass", "juan@example.com");

            Call<Empleado> call = CrudEmpleadoInterface.actualizarEmpleado(Long.valueOf(id), empleado);
            call.enqueue(new Callback<Empleado>() {
                @Override
                public void onResponse(Call<Empleado> call, Response<Empleado> response) {
                    if (response.isSuccessful()) {
